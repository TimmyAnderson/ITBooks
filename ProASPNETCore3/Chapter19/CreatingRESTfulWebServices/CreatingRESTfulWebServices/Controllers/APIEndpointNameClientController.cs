...
{
//----------------------------------------------------------------------------------------------------------------------
	public class APIEndpointNameClientController : Controller
	{
//----------------------------------------------------------------------------------------------------------------------
		public async Task<ViewResult> TestGetNames()
		{
			HttpClient											Client=new HttpClient();
			HttpResponseMessage									Response=await Client.GetAsync("http://localhost:50000/api/APIEndpointName");
...
//----------------------------------------------------------------------------------------------------------------------
		...
		{
			HttpClient											Client=new HttpClient();
			HttpResponseMessage									Response=await Client.GetAsync("http://localhost:50000/api/APIEndpointName/1");
...
//----------------------------------------------------------------------------------------------------------------------
		...
		{
			HttpClient											Client=new HttpClient();
			HttpResponseMessage									Response=await Client.GetAsync("http://localhost:50000/api/APIEndpointName/2");
...
//----------------------------------------------------------------------------------------------------------------------
		public async Task<ViewResult> TestPostName()
		{
			...
			HttpResponseMessage									Response=await Client.PostAsync("http://localhost:50000/api/APIEndpointName",RequestContent);
...
//----------------------------------------------------------------------------------------------------------------------
		public async Task<ViewResult> TestPutName1()
		{
			...
			HttpResponseMessage									Response=await Client.PutAsync("http://localhost:50000/api/APIEndpointName",RequestContent);
...
//----------------------------------------------------------------------------------------------------------------------
		...
		public async Task<ViewResult> TestPatchName1()
		{
			...
			HttpResponseMessage									Response=await Client.PatchAsync("http://localhost:50000/api/APIEndpointName/patch/1",RequestContent);
...
//----------------------------------------------------------------------------------------------------------------------
		...
		public async Task<ViewResult> TestPatchName2()
		{
			...
			HttpClient											Client=new HttpClient();
			StringContent										RequestContent=new StringContent(PatchBody,Encoding.UTF8,"application/json");
			HttpResponseMessage									Response=await Client.PatchAsync("http://localhost:50000/api/APIEndpointName/patch/2",RequestContent);
...
//----------------------------------------------------------------------------------------------------------------------
		...
		{
			HttpClient											Client=new HttpClient();
			HttpResponseMessage									Response=await Client.DeleteAsync("http://localhost:50000/api/APIEndpointName/1");
...
//----------------------------------------------------------------------------------------------------------------------
		...
		{
			HttpClient											Client=new HttpClient();
			HttpResponseMessage									Response=await Client.DeleteAsync("http://localhost:50000/api/APIEndpointName/2");
