...
//----------------------------------------------------------------------------------------------------------------------
	...
	{
//----------------------------------------------------------------------------------------------------------------------
		// !!!!! Tato CONFIGURATION je NUTNA, aby bezal BLAZOR WEB ASSEMBLY PROJECT.
		private static void ConfigureApplicationConfiguration(WebHostBuilderContext Context, IConfigurationBuilder Builfer)
		{
...
//----------------------------------------------------------------------------------------------------------------------
		...
		{
			// !!!!! Tato CONFIGURATION je NUTNA, aby bezal BLAZOR WEB ASSEMBLY PROJECT.
			WebHostBuilder.ConfigureAppConfiguration(ConfigureApplicationConfiguration);
...
//			CustomHostBuilder.ConfigureWebHostDefaults(WebBuilder => { WebBuilder.UseStartup<Startup>();});
