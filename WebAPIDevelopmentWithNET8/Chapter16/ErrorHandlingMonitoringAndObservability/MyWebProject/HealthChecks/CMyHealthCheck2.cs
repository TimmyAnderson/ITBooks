...
{
//----------------------------------------------------------------------------------------------------------------------
	public sealed class CMyHealthCheck2 : IHealthCheck
	{
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
		public Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext Context, CancellationToken CancellationToken)
		{
			...
			{
				HealthCheckResult								Result=HealthCheckResult.Healthy("CHECK 2 - STATUS [HEALTHY].");
			...
			{
				HealthCheckResult								Result=HealthCheckResult.Degraded("CHECK 2 - STATUS [DEGRADED].");
				Task<HealthCheckResult>							ResultTask=Task.FromResult<HealthCheckResult>(Result);
			...
			{
				HealthCheckResult								Result=HealthCheckResult.Unhealthy("CHECK 2 - STATUS [UNHEALTHY].");
				Task<HealthCheckResult>							ResultTask=Task.FromResult<HealthCheckResult>(Result);
			...
			{
				HealthCheckResult								Result=HealthCheckResult.Unhealthy("CHECK 2 - UNKNOWN STATUS.");
				Task<HealthCheckResult>							ResultTask=Task.FromResult<HealthCheckResult>(Result);
