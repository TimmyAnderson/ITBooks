...
//----------------------------------------------------------------------------------------------------------------------
		public void ConfigureServices(IServiceCollection Services)
		{
			...
			Services.AddServerSideBlazor().AddCircuitOptions(P => P.DetailedErrors=true);

			CDBOperationsInMemory								DBOperationsInMemory=new CDBOperationsInMemory();

			DBOperationsInMemory.AddPerson(new CPerson(1,"Timmy","Anderson",12,ESex.Male));
			DBOperationsInMemory.AddPerson(new CPerson(2,"Jenny","Thompson",13,ESex.Female));

			Services.AddSingleton<IDBOperationsInMemory>(DBOperationsInMemory);
...
//----------------------------------------------------------------------------------------------------------------------
		public void Configure(IApplicationBuilder ApplicationBuilder, IWebHostEnvironment WebHostEnvironment)
		{
			...
			ApplicationBuilder.UseEndpoints(Endpoints =>
			{
				...
				Endpoints.MapFallbackToPage("/PageRouteFallback");
			});
		}
//----------------------------------------------------------------------------------------------------------------------
	}
