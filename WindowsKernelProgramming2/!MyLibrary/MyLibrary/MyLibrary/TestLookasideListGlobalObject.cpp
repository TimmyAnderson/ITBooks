...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
CLookasideListGlobal<CLookasideEntry>							LookasideListGlobalObject;
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
NTSTATUS TestLookasideListGlobalObject(DEVICE_OBJECT* DeviceObject, IRP* Irp)
{
	...
	Status=LookasideListGlobalObject.Init(POOL_TYPE::PagedPool,MY_TAG);
	...
	if (NT_SUCCESS(Status)!=false)
	{
		...
		CLookasideEntry*										Object1=static_cast<CLookasideEntry*>(LookasideListGlobalObject.Alloc());
		...
		if (Object1!=nullptr)
		{
			...
			// !!! Alokuje sa MEMORY BLOCK z LOOKASIDE LIST.
			CLookasideEntry*									Object2=static_cast<CLookasideEntry*>(LookasideListGlobalObject.Alloc());
			...
			if (Object2!=nullptr)
			{
				...
				LookasideListGlobalObject.Free(Object2);
			}
			else
			{
			...
			// !!! Uvolni MEMORY BLOCK v LOOKASIDE LIST.
			LookasideListGlobalObject.Free(Object1);
		}
		else
		{
		...
		LookasideListGlobalObject.Delete();
	}
	else
	{
