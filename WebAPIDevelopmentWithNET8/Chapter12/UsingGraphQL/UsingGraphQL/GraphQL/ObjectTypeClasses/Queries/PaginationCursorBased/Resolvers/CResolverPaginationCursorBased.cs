...
//----------------------------------------------------------------------------------------------------------------------
	...
	public sealed class CResolverPaginationCursorBased
	{
//----------------------------------------------------------------------------------------------------------------------
		public async Task<IQueryable<CEntityPaginationCursorBased>> FieldResolverDelegateArray(IResolverContext Context)
		{
			// !!! SERVICE sa ziska PROGRAMOVO.
			IMyLoggerService									MyLoggerService=Context.Service<IMyLoggerService>();

			MyLoggerService.LogResolver(nameof(CResolverPaginationCursorBased),nameof(FieldResolverDelegateArray));
			...
			IQueryable<CEntityPaginationCursorBased>			Result=DBContext.EntitiesPaginationCursorBased.AsQueryable();
