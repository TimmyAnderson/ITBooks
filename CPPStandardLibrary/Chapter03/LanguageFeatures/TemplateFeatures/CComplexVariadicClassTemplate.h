...
//-------------------------------------------------------------------------------------------------------
	public:
		CComplexVariadicClassTemplate(void)
		{
			...
			std::wcout << L"BASE CLASS - NumberOfItems [" << NumberOfItems << L"] !" << std::endl;
		}
...
//-------------------------------------------------------------------------------------------------------
	...
	public:
		...
		void DoRecursion(void)
		{
			std::wcout << L"SIZEOF() [" << sizeof...(TOtherItems) << L"] VALUE [" << MFirstItem << "] !" << std::endl;
	...
	public:
			...
			: CComplexVariadicClassTemplate<TOtherItems...>(OtherItems...), MFirstItem(FirstItem)
		{
			...
			std::wcout << L"DERIVED CLASS - NumberOfItems [" << NumberOfItems << L"] !" << std::endl;
		}
//-------------------------------------------------------------------------------------------------------
};
//-------------------------------------------------------------------------------------------------------