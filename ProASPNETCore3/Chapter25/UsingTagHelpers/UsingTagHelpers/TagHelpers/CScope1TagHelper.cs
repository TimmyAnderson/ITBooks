...
{
//----------------------------------------------------------------------------------------------------------------------
	// !!! TAG HELPER sa aplikuje IBA na HTML ELEMENTS [<div>] ak sa nachadzaju v PARENT HTML ELEMENT [<main>].
	[HtmlTargetElement("div",ParentTag="main")]
	public sealed class CScope1TagHelper : TagHelper
	{
//----------------------------------------------------------------------------------------------------------------------
