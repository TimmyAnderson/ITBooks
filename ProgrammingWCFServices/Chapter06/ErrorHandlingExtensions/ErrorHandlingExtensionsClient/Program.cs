...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CErrorHandlingExtensionsProxy		Client=null;
			...
			try
			{
				Client=new CErrorHandlingExtensionsProxy(TCPBinding,"net.tcp://localhost:9001/IErrorHandlingExtensionsContract");

				try
				{
					Client.CaughtException();
					Client.PromoteAllException();
				}
