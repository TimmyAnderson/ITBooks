...
//----------------------------------------------------------------------------------------------------------------------
	...
	public sealed class Derived2CV : ViewComponent
	{
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
		...
		public Derived2CV(INameProvider NameProvider)
		{
...
//----------------------------------------------------------------------------------------------------------------------
		...
		public ViewViewComponentResult Invoke()
		{
			...
			ViewViewComponentResult								Result=View("MyDerivedPartialView",Model);
