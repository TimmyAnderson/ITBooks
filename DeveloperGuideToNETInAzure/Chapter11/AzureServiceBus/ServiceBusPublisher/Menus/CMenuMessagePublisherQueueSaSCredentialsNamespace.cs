...
{
//--------------------------------------------------------------------------------------------------------------------------------
	public sealed class CMenuMessagePublisherQueueSaSCredentialsNamespace : CMenu
	{
//--------------------------------------------------------------------------------------------------------------------------------
		public CMenuMessagePublisherQueueSaSCredentialsNamespace()
...
//--------------------------------------------------------------------------------------------------------------------------------
		...
		{
			string												SaSToken=CreateSaSToken(CConstants.SERVICE_BUS_FULLY_QUALIFIED_NAMESPACE_URL,CConstants.SAS_AUTHORIZATION_RULE_SERVICE_BUS_NAMESPACE_NAME_PUBLISHER,CConstants.SAS_AUTHORIZATION_RULE_SERVICE_BUS_NAMESPACE_KEY_PUBLISHER);
