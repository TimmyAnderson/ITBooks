...
//-------------------------------------------------------------------------------------------------------
		public static CSyntaxTreeNode CreateParseTreeNode(CChoice Choice, CParsingStackItem[] ParsingStackItems)
		{
			...
			{
				if (Choice.Symbols.Length==2 && Choice.Symbols[0].Name=="EXPRESSION" && Choice.Symbols[1].Name=="TerminalSemicolon")
				{
			...
			{
				if (Choice.Symbols.Length==3 && Choice.Symbols[0].Name=="VARIABLE" && Choice.Symbols[1].Name=="TerminalAssigment" && Choice.Symbols[2].Name=="EXPRESSION")
				{
					CSyntaxTreeNode_EXPRESSION				TreeNode=new CSyntaxTreeNode_EXPRESSION(Choice,ParsingStackItems[0],ParsingStackItems[2]);

					return(TreeNode);
				}
				else if (Choice.Symbols.Length==1 && Choice.Symbols[0].Name=="SIMPLE_EXPRESSION")
				{
			...
			else if (Choice.Nonterminal.Name=="SIMPLE_EXPRESSION")
			{
				...
				{
					CSyntaxTreeNode_SIMPLE_EXPRESSION		TreeNode=new CSyntaxTreeNode_SIMPLE_EXPRESSION(Choice,ParsingStackItems[0],ParsingStackItems[1],ParsingStackItems[2]);

					return(TreeNode);
				}
				else if (Choice.Symbols.Length==1 && Choice.Symbols[0].Name=="ADDITIVE_EXPRESSION")
				{
					CSyntaxTreeNode_SIMPLE_EXPRESSION		TreeNode=new CSyntaxTreeNode_SIMPLE_EXPRESSION(Choice,ParsingStackItems[0]);
