...
//-------------------------------------------------------------------------------------------------------
namespace TransactionalQueueService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CTransactionalQueueService>		Service=new CServiceHostWrapper<CTransactionalQueueService>();
			...
			Service.AddServiceEndpoint<ITransactionalQueueContract>(TCPBinding,QueueName);
