...
//----------------------------------------------------------------------------------------------------------------------
class CNonIsNoThrowCopyConstructible final
{
//----------------------------------------------------------------------------------------------------------------------
	private:
		int														MField1;
	...
	public:
		CNonIsNoThrowCopyConstructible(int Field1, double Field2);
		CNonIsNoThrowCopyConstructible(const CNonIsNoThrowCopyConstructible& Other);
		~CNonIsNoThrowCopyConstructible(void);
//----------------------------------------------------------------------------------------------------------------------
};
//----------------------------------------------------------------------------------------------------------------------