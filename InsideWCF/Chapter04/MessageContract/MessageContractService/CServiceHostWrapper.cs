...
//-------------------------------------------------------------------------------------------------------
		public CServiceHostWrapper(Uri BaseAddress)
		{
			MSyn=new object();
			MHost=new ServiceHost(typeof(T),BaseAddress);
...
//-------------------------------------------------------------------------------------------------------
		public void AddHTTPMEXEndpoint(string MEXEndpoindName)
		{
			lock(MSyn)
			{
				try
				{
					BindingElement			BE=new HttpTransportBindingElement();
					CustomBinding			CB=new CustomBinding(BE);
					ServiceMetadataBehavior SMB;
