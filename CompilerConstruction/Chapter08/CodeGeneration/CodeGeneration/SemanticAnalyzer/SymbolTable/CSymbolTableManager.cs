...
//-------------------------------------------------------------------------------------------------------
	...
	{
//-------------------------------------------------------------------------------------------------------
		// !!!!! Velkost odkial v STACK zacinaju PARAMETRE FUNKCIE. Jej hodnota je 3*SIZEOF(POINTER), pretoze KAZDE VOLANIE FUNKCIE ulozi na STACK RETURN VALUE a na zaciatku kazdej FUNKCIE su 2 PUSH INSTRUKCIE na odpamatanie registrov.
		private static readonly int								FUNCTION_BASE_ADDRESS_OFFSET=3*CSymbolTableData_Variable.POINTER_SIZE;
//-------------------------------------------------------------------------------------------------------
