		...
		private void TraversePostOrderAction_VARIABLE_DECLARATION_Choice2(CParseTreeNode Node, CParseTreeTraverseItem TraverseItem)
		{
			...
			if (Type!=null)
			{
				if (MCurrentTable.ContainsSymbolInCurrentOrParentScopes(SymbolName)==true)
				{
					...
					if (SymbolFromSymbolTable.SymbolType!=Type.SymbolType)
					{
...
//-------------------------------------------------------------------------------------------------------
		...
		private void TraversePostOrderAction_VARIABLE_Choice1(CParseTreeNode Node, CParseTreeTraverseItem TraverseItem)
		{
			...
			if (MCurrentTable.ContainsSymbolInCurrentOrParentScopes(SymbolName)==true)
			{
				...
				if (SymbolFromSymbolTable.SymbolType==ESymbolType.E_ST_INT || SymbolFromSymbolTable.SymbolType==ESymbolType.E_ST_STRING || SymbolFromSymbolTable.SymbolType==ESymbolType.E_ST_INT_ARRAY || SymbolFromSymbolTable.SymbolType==ESymbolType.E_ST_STRING_ARRAY)
				{
					ESymbolType							SymbolType=SymbolFromSymbolTable.SymbolType;
...
//-------------------------------------------------------------------------------------------------------
		...
		private void TraversePostOrderAction_VARIABLE_Choice2(CParseTreeNode Node, CParseTreeTraverseItem TraverseItem)
		{
			...
			if (MCurrentTable.ContainsSymbolInCurrentOrParentScopes(SymbolName)==true)
			{
				...
				if (SymbolFromSymbolTable.SymbolType==ESymbolType.E_ST_INT_ARRAY || SymbolFromSymbolTable.SymbolType==ESymbolType.E_ST_STRING_ARRAY)
				{
					ESymbolType							SymbolType=SymbolFromSymbolTable.SymbolType;
		...
		private void TraversePostOrderAction_CALL(CParseTreeNode Node, CParseTreeTraverseItem TraverseItem)
		{
			...
			if (ParamTypes!=null)
			{
				...
				if (MCurrentTable.ContainsSymbolInCurrentOrParentScopes(SymbolName)==true)
				{
					...
					if ((SymbolFromSymbolTable is CSymbolTableItem_Function)==true)
					{
						CSymbolTable_Function			FunctionTable=MCurrentTable.GetFunctionSymbolTable(SymbolName);

						if (FunctionTable!=null)
						{
							CSymbolTableItem_Function	TypedSymbolFromSymbolTable=(CSymbolTableItem_Function) SymbolFromSymbolTable;
							...
							CSymbolTableItem_Param[]	Params=FunctionTable.GetParamTypes();
