...
{
//----------------------------------------------------------------------------------------------------------------------
	// !!! RAZOR PAGE je pristupna iba pre ROLE 'Administrators'.
	[Authorize(Roles="Administrators")]
    public class ShowUserAndRolesForAdministratorsModel : PageModel
    {
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		public ShowUserAndRolesForAdministratorsModel(UserManager<CCustomUser> UserManager, RoleManager<CCustomRole> RoleManager, SignInManager<CCustomUser> SignInManager)
		{
