...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CSimpleCallbackService>		Service=new CServiceHostWrapper<CSimpleCallbackService>();
			...
			Service.AddServiceEndpoint<ISimpleCallbackContract>(TCPBinding,"net.tcp://localhost:9001/ISimpleCallbackContract");
