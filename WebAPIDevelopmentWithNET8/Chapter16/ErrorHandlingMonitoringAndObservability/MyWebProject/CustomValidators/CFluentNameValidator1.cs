...
//----------------------------------------------------------------------------------------------------------------------
	...
	public sealed class CFluentNameValidator1 : AbstractValidator<CFluentName1>
	{
//----------------------------------------------------------------------------------------------------------------------
		public CFluentNameValidator1()
		{
			IRuleBuilderInitial<CFluentName1,string>			FirstNameRule=RuleFor(P => P.FirstName);
			...
			IRuleBuilderInitial<CFluentName1,string>			LastNameRule=RuleFor(P => P.LastName);
			...
			IRuleBuilderInitial<CFluentName1,int>				AgeRule=RuleFor(P => P.Age);
