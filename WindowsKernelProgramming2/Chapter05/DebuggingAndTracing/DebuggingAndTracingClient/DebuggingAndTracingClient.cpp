...
#include "..\DebuggingAndTracing\SThreadData.h"
//----------------------------------------------------------------------------------------------------------------------
#ifdef _MSC_VER
...
int main(int argc, const char* argv[])
{
	...
	do
	{
		if (argc<3)
		{
			wcout << L"USE [DebuggingAndTracingClient.exe THREAD_ID PRIORITY]." << endl;
			break;
		}
		...
		const wchar_t*											SymbolicLinkName=LR"(\\.\DebuggingAndTracing)";
