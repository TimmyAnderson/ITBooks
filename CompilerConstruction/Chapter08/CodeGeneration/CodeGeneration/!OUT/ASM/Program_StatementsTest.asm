...
PUSH EBX                                          ; [VARIABLE -> [FUNCTION_DECLARATION -> TYPE_SPECIFIER id(PARAMS) COMPOUND_STATEMENT]] - Stores original value of EBX to STACK.
MOV EBP,ESP                                       ; [VARIABLE -> [FUNCTION_DECLARATION -> TYPE_SPECIFIER id(PARAMS) COMPOUND_STATEMENT]] - Moves ESP to EBP to store begin address of LOCAL VARIABLES.
SUB ESP,000Ch                                     ; [VARIABLE -> [FUNCTION_DECLARATION -> TYPE_SPECIFIER id(PARAMS) COMPOUND_STATEMENT]] - Allocates memory for local variables.
MOV EAX,0000h                                     ; [CONST -> num] - Moves INT constant to EAX.
PUSH EAX                                          ; [CONST -> num] - Push INT constant to STACK.
POP EAX                                           ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Gets value of constant for variable [Counter1] to EAX.
MOV [EBP-4],EAX                                   ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Moves value of constant for variable [Counter1] to STACK.
BEFORE_WHILE_Sort_1:                              ; [ITERATION_STATEMENT -> while (EXPRESSION) STATEMENT] - Label to BEGIN of WHILE block.
MOV EAX,EBP                                       ; [VARIABLE -> id] - Moves EBP for local variable array [Counter1] to EAX.
ADD EAX,-0004h                                    ; [VARIABLE -> id] - Adds offset for symbol [Counter1] to EAX. Now EAX contains address of symbol [Counter1].
PUSH EAX                                          ; [VARIABLE -> id] - Pushs address of variable [Counter1] to STACK.
POP EAX                                           ; [VARIABLE -> [FACTOR -> VARIABLE]] - Gets address of variable [Counter1] to EAX.
MOV EAX,[EAX]                                     ; [VARIABLE -> [FACTOR -> VARIABLE]] - Moves value of variable [Counter1] from address of variable.
PUSH EAX                                          ; [VARIABLE -> [FACTOR -> VARIABLE]] - Puts value of variable [Counter1] to STACK.
MOV EAX,EBP                                       ; [VARIABLE -> id] - Moves EBP for local variable array [ArrayToSortSize] to EAX.
ADD EAX,000Ch                                     ; [VARIABLE -> id] - Adds offset for symbol [ArrayToSortSize] to EAX. Now EAX contains address of symbol [ArrayToSortSize].
PUSH EAX                                          ; [VARIABLE -> id] - Pushs address of variable [ArrayToSortSize] to STACK.
POP EAX                                           ; [VARIABLE -> [FACTOR -> VARIABLE]] - Gets address of variable [ArrayToSortSize] to EAX.
...
POP EAX                                           ; [ITERATION_STATEMENT -> while (EXPRESSION) STATEMENT] - Gets value of EXPRESSION to EAX.
...
ADD EAX,-0008h                                    ; [VARIABLE -> id] - Adds offset for symbol [Counter2] to EAX. Now EAX contains address of symbol [Counter2].
...
ADD EAX,-0008h                                    ; [VARIABLE -> id] - Adds offset for symbol [Counter2] to EAX. Now EAX contains address of symbol [Counter2].
PUSH EAX                                          ; [VARIABLE -> id] - Pushs address of variable [Counter2] to STACK.
POP EAX                                           ; [VARIABLE -> [FACTOR -> VARIABLE]] - Gets address of variable [Counter2] to EAX.
...
MOV EAX,[EBP+16]                                  ; [VARIABLE -> id[EXPRESSION]] - Moves array base address [EBP+StackOffset] for parameter array [ArrayToSort] to EAX.
...
POP EAX                                           ; [VARIABLE -> [FACTOR -> VARIABLE]] - Gets address of variable [ArrayToSort] to EAX.
...
ADD EAX,-000Ch                                    ; [VARIABLE -> id] - Adds offset for symbol [Temp] to EAX. Now EAX contains address of symbol [Temp].
...
ADD EAX,-000Ch                                    ; [VARIABLE -> id] - Adds offset for symbol [Temp] to EAX. Now EAX contains address of symbol [Temp].
PUSH EAX                                          ; [VARIABLE -> id] - Pushs address of variable [Temp] to STACK.
POP EAX                                           ; [VARIABLE -> [FACTOR -> VARIABLE]] - Gets address of variable [Temp] to EAX.
MOV EAX,[EAX]                                     ; [VARIABLE -> [FACTOR -> VARIABLE]] - Moves value of variable [Temp] from address of variable.
PUSH EAX                                          ; [VARIABLE -> [FACTOR -> VARIABLE]] - Puts value of variable [Temp] to STACK.
POP EBX                                           ; [EXPRESSION_STATEMENT -> VARIABLE=EXPRESSION;] - Gets value of EXPRESSION for operation ASSIGNMENT to EBX.
POP EAX                                           ; [EXPRESSION_STATEMENT -> VARIABLE=EXPRESSION;] - Gets address of VARIABLE for operation ASSIGNMENT to EAX.
MOV [EAX],EBX                                     ; [EXPRESSION_STATEMENT -> VARIABLE=EXPRESSION;] - Moves value of EXPRESSION to VARIABLE.
...
PUSH EAX                                          ; [CONST -> num] - Push INT constant to STACK.
POP EAX                                           ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Gets value of constant for variable [X] to EAX.
MOV [EBP-4],EAX                                   ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Moves value of constant for variable [X] to STACK.
MOV EAX,0003h                                     ; [CONST -> num] - Moves INT constant to EAX.
PUSH EAX                                          ; [CONST -> num] - Push INT constant to STACK.
POP EAX                                           ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Gets value of constant for variable [Y] to EAX.
MOV [EBP-8],EAX                                   ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Moves value of constant for variable [Y] to STACK.
MOV EAX,EBP                                       ; [VARIABLE -> id] - Moves EBP for local variable array [Result] to EAX.
ADD EAX,-000Ch                                    ; [VARIABLE -> id] - Adds offset for symbol [Result] to EAX. Now EAX contains address of symbol [Result].
...
ADD EAX,-0004h                                    ; [VARIABLE -> id] - Adds offset for symbol [X] to EAX. Now EAX contains address of symbol [X].
...
ADD EAX,-0008h                                    ; [VARIABLE -> id] - Adds offset for symbol [Y] to EAX. Now EAX contains address of symbol [Y].
...
ADD EAX,-000Ch                                    ; [VARIABLE -> id] - Adds offset for symbol [Result] to EAX. Now EAX contains address of symbol [Result].
PUSH EAX                                          ; [VARIABLE -> id] - Pushs address of variable [Result] to STACK.
POP EAX                                           ; [VARIABLE -> [FACTOR -> VARIABLE]] - Gets address of variable [Result] to EAX.
...
MOV EAX,0001h                                     ; [CONST -> num] - Moves INT constant to EAX.
PUSH EAX                                          ; [CONST -> num] - Push INT constant to STACK.
POP EAX                                           ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Gets value of constant for variable [Counter2] to EAX.
MOV [EBP-8],EAX                                   ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Moves value of constant for variable [Counter2] to STACK.
...
PUSH EAX                                          ; [CONST -> num] - Push INT constant to STACK.
POP EAX                                           ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Gets value of constant for variable [Value] to EAX.
MOV [EBP-4],EAX                                   ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Moves value of constant for variable [Value] to STACK.
MOV EAX,EBP                                       ; [VARIABLE -> id] - Moves EBP for local variable array [Value] to EAX.
ADD EAX,-0004h                                    ; [VARIABLE -> id] - Adds offset for symbol [Value] to EAX. Now EAX contains address of symbol [Value].
PUSH EAX                                          ; [VARIABLE -> id] - Pushs address of variable [Value] to STACK.
POP EAX                                           ; [VARIABLE -> [FACTOR -> VARIABLE]] - Gets address of variable [Value] to EAX.
MOV EAX,[EAX]                                     ; [VARIABLE -> [FACTOR -> VARIABLE]] - Moves value of variable [Value] from address of variable.
PUSH EAX                                          ; [VARIABLE -> [FACTOR -> VARIABLE]] - Puts value of variable [Value] to STACK.
...
PUSH EBX                                          ; [VARIABLE -> [FUNCTION_DECLARATION -> TYPE_SPECIFIER id(PARAMS) COMPOUND_STATEMENT]] - Stores original value of EBX to STACK.
MOV EBP,ESP                                       ; [VARIABLE -> [FUNCTION_DECLARATION -> TYPE_SPECIFIER id(PARAMS) COMPOUND_STATEMENT]] - Moves ESP to EBP to store begin address of LOCAL VARIABLES.
SUB ESP,002Ch                                     ; [VARIABLE -> [FUNCTION_DECLARATION -> TYPE_SPECIFIER id(PARAMS) COMPOUND_STATEMENT]] - Allocates memory for local variables.
MOV EAX,0000h                                     ; [CONST -> num] - Moves INT constant to EAX.
PUSH EAX                                          ; [CONST -> num] - Push INT constant to STACK.
POP EAX                                           ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Gets value of constant for variable [Counter] to EAX.
MOV [EBP-44],EAX                                  ; [VARIABLE_DECLARATION -> TYPE_SPECIFIER id=CONST;] - Moves value of constant for variable [Counter] to STACK.
MOV EAX,0003h                                     ; [FACTOR -> num] - Moves INT constant to EAX.
PUSH EAX                                          ; [FACTOR -> num] - Pushs INT constant to STACK.
...
MOV EAX,EBP                                       ; [VARIABLE -> id] - Moves EBP for local variable array [Counter] to EAX.
ADD EAX,-002Ch                                    ; [VARIABLE -> id] - Adds offset for symbol [Counter] to EAX. Now EAX contains address of symbol [Counter].
PUSH EAX                                          ; [VARIABLE -> id] - Pushs address of variable [Counter] to STACK.
POP EAX                                           ; [VARIABLE -> [FACTOR -> VARIABLE]] - Gets address of variable [Counter] to EAX.
MOV EAX,[EAX]                                     ; [VARIABLE -> [FACTOR -> VARIABLE]] - Moves value of variable [Counter] from address of variable.
PUSH EAX                                          ; [VARIABLE -> [FACTOR -> VARIABLE]] - Puts value of variable [Counter] to STACK.
MOV EAX,000Ah                                     ; [FACTOR -> num] - Moves INT constant to EAX.
PUSH EAX                                          ; [FACTOR -> num] - Pushs INT constant to STACK.
POP EBX                                           ; [EXPRESSION -> ADDITIVE_EXPRESSION COMPARE_OPERATION ADDITIVE_EXPRESSION] - Gets OPERAND O2 for operation COMPARE to EBX.
POP EAX                                           ; [EXPRESSION -> ADDITIVE_EXPRESSION COMPARE_OPERATION ADDITIVE_EXPRESSION] - Gets OPERAND O1 for operation COMPARE to EAX.
...
ADD EAX,EBX                                       ; [VARIABLE -> id[EXPRESSION]] - Adds array index byt offset for array [Values] to EAX. Now EAX contains address of [Values[EXPRESSION]].
PUSH EAX                                          ; [VARIABLE -> id[EXPRESSION]] - Pushs address of variable [Values[EXPRESSION]] to STACK.
POP EAX                                           ; [VARIABLE -> [FACTOR -> VARIABLE]] - Gets address of variable [Values] to EAX.
