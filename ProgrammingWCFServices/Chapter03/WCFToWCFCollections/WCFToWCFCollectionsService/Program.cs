...
//-------------------------------------------------------------------------------------------------------
namespace WCFToWCFCollectionsService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CWCFToWCFCollectionsService>	Service=new CServiceHostWrapper<CWCFToWCFCollectionsService>();
			...
			Service.AddServiceEndpoint<IWCFToWCFCollectionsContract>(TCPBinding,"net.tcp://localhost:9001/IWCFToWCFCollectionsContract");
