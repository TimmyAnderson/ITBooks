...
using DCEquivalenceLibrary;
//-------------------------------------------------------------------------------------------------------
namespace DCEquivalenceService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CDCEquivalenceService>		Service=new CServiceHostWrapper<CDCEquivalenceService>();
			...
			Service.AddServiceEndpoint<IDCEquivalenceContract>(TCPBinding,"net.tcp://localhost:9001/IDCEquivalenceContract");
