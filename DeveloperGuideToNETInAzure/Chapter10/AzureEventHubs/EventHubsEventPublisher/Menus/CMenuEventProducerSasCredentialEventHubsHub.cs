...
{
//--------------------------------------------------------------------------------------------------------------------------------
	public sealed class CMenuEventProducerSasCredentialEventHubsHub : CMenu
	{
//--------------------------------------------------------------------------------------------------------------------------------
		public CMenuEventProducerSasCredentialEventHubsHub()
...
//--------------------------------------------------------------------------------------------------------------------------------
		...
		{
			string												SaSToken=CreateSaSToken(CConstants.EVENT_HUB_FULLY_QUALIFIED_HUB_URL,CConstants.SAS_AUTHORIZATION_RULE_EVENT_HUBS_HUB_NAME_PRODUCER,CConstants.SAS_AUTHORIZATION_RULE_EVENT_HUBS_HUB_KEY_PRODUCER);
