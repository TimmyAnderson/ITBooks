...
//-------------------------------------------------------------------------------------------------------
		public bool HasGotoCell(CNonterminal Nonterminal)
		{
			foreach(CParsingTableCell ParsingTableCell in MCells)
			{
				if ((ParsingTableCell.Operation is CParsingTableOperation_Goto)==true && ParsingTableCell.Symbol.Equals(Nonterminal)==true)
				{
					return(true);
				}
			}
