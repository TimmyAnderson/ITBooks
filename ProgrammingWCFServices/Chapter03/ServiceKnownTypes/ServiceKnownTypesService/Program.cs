...
//-------------------------------------------------------------------------------------------------------
namespace ServiceKnownTypesService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CServiceKnownTypesService>	Service=new CServiceHostWrapper<CServiceKnownTypesService>();
			...
			Service.AddServiceEndpoint<IServiceKnownTypesContract>(TCPBinding,"net.tcp://localhost:9001/IServiceKnownTypesContract");
