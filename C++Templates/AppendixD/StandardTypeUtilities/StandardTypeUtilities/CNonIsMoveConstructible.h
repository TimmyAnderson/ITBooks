...
//----------------------------------------------------------------------------------------------------------------------
class CNonIsMoveConstructible final
{
//----------------------------------------------------------------------------------------------------------------------
	private:
		int														MField1;
	...
	public:
		CNonIsMoveConstructible(int Field1, double Field2);
		CNonIsMoveConstructible(CNonIsMoveConstructible&& Other)=delete;
		~CNonIsMoveConstructible(void);
//----------------------------------------------------------------------------------------------------------------------
};
//----------------------------------------------------------------------------------------------------------------------