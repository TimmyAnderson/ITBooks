...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CSingletonMSMQService>			Service=new CServiceHostWrapper<CSingletonMSMQService>();
			...
			Service.AddServiceEndpoint<ISingletonMSMQContract>(TCPBinding,QueueName);
