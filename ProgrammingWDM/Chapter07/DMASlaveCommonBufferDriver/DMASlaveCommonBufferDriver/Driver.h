...
typedef struct _DEVICE_EXTENSION
{
	...
	// POINTER na VIRTUAL MEMORY COMMON BUFFER. Tento POINTER pouziva DRIVER na pracu s COMMON BUFFER pri realizacii DMA TRANSFER.
	PVOID														CommonBufferVirtualMemory;
	// LOGICAL ADDRESS COMMON BUFFER. LOGICAL ADDRESS (trochu nelogicky nazov) pouziva HW DEVICE na pracu s COMMON BUFFER pri realizacii DMA TRANSFER.
	PHYSICAL_ADDRESS											CommonBufferLogicalAddress;
	// MDL referujuci na COMMON BUFFER.
