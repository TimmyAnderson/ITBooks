...
//-------------------------------------------------------------------------------------------------------
namespace OperationOverloadingService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CAddService>		Service=new CServiceHostWrapper<CAddService>();
			...
			Service.AddServiceEndpoint<IAddContract>(TCPBinding,"net.tcp://localhost:9001/IAddContract");
