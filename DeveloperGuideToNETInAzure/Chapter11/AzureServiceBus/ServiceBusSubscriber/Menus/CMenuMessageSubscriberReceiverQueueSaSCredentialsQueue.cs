...
{
//--------------------------------------------------------------------------------------------------------------------------------
	public sealed class CMenuMessageSubscriberReceiverQueueSaSCredentialsQueue : CMenu
	{
//--------------------------------------------------------------------------------------------------------------------------------
		public CMenuMessageSubscriberReceiverQueueSaSCredentialsQueue()
...
//--------------------------------------------------------------------------------------------------------------------------------
		...
		{
			string												SaSToken=CreateSaSToken(CConstants.SERVICE_BUS_FULLY_QUALIFIED_QUEUE_URL,CConstants.SAS_AUTHORIZATION_RULE_SERVICE_BUS_QUEUE_NAME_SUBSCRIBER,CConstants.SAS_AUTHORIZATION_RULE_SERVICE_BUS_QUEUE_KEY_SUBSCRIBER);
