...
{
//----------------------------------------------------------------------------------------------------------------------
	public sealed class BindAttribute2Controller : Controller
	{
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
		...
		// !!!!! IBA PROPERTY 'CSuperChildAddress.City' bude BOUND. PROPERTY 'CSuperChildAddress.Country' ostane UNBOUND.
		[HttpPost]
		public IActionResult EditChildCallback([Bind(Prefix=nameof(CChild.ID))] int SuperID, [Bind(Prefix=nameof(CChild.FirstName))] string SuperFirstName, [Bind(Prefix=nameof(CChild.LastName))] string SuperLastName, [Bind(Prefix=nameof(CChild.Age))] int SuperAge, [Bind(Prefix=nameof(CChild.Sex))] ESex SuperSex, [Bind(nameof(CSuperChildAddress.City),Prefix=nameof(CChild.Address))] CSuperChildAddress SuperAddress)
		{
