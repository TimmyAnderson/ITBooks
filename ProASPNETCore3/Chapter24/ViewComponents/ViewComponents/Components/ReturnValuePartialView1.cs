...
//----------------------------------------------------------------------------------------------------------------------
	...
	public sealed class ReturnValuePartialView1 : ViewComponent
	{
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
		...
		public ReturnValuePartialView1(INameProvider NameProvider)
		{
...
//----------------------------------------------------------------------------------------------------------------------
		...
		public ViewViewComponentResult Invoke()
		{
			...
			ViewViewComponentResult								Result=View("ReturnValuePartialView",Model);
