...
{
//----------------------------------------------------------------------------------------------------------------------
	public static class CCachedSlidingLongCalculationEndpoint
	{
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
		public static async Task Endpoint(HttpContext Context)
		{
			...
			string												Key=nameof(CCachedSlidingLongCalculationEndpoint);
			...
			if (CachedValue==null)
			{
				...
				TimeSpan										SlidingTime=TimeSpan.FromSeconds(30);

				SB.Append($" TIME [{CreateTime()}] - CACHED for SLIDING TIME [{SlidingTime} SECONDS] !");
				...
				// !!! Nastavi sa SLIDING CACHE EXPIRATION TIME.
				CacheOptions.SlidingExpiration=SlidingTime;
