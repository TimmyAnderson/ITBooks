...
//----------------------------------------------------------------------------------------------------------------------
	...
	public sealed class CEntityAttributeOnNavigationPropertyDependentDataAnnotations
	{
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
		...
		private CEntityAttributeOnNavigationPropertyPrincipalDataAnnotations	MEntityPrincipal;
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		public CEntityAttributeOnNavigationPropertyDependentDataAnnotations()
		{
...
//----------------------------------------------------------------------------------------------------------------------
		public CEntityAttributeOnNavigationPropertyDependentDataAnnotations(string EntityDependentValue)
		{
			MEntityDependentID=default;
...
//----------------------------------------------------------------------------------------------------------------------
		public CEntityAttributeOnNavigationPropertyDependentDataAnnotations(string EntityDependentValue, CEntityAttributeOnNavigationPropertyPrincipalDataAnnotations EntityPrincipal)
		{
			MEntityDependentID=default;
			MEntityDependentValue=EntityDependentValue;
			MEntityPrincipalID=default;
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		// !!! APLIKUJE sa FOREIGN KEY ATTRIBUTE na NAVIGATION PROPERTY, ktory odkazuje na FOREIGN KEY PROPERTY.
		[ForeignKey(nameof(ForeignKeyEntityPrincipalID))]
		public CEntityAttributeOnNavigationPropertyPrincipalDataAnnotations	EntityPrincipal
		{
			get
			{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		public static void PrintToConsole(CEntityAttributeOnNavigationPropertyDependentDataAnnotations[] Entities)
		{
			for(int Index=0;Index<Entities.Length;Index++)
			{
				CEntityAttributeOnNavigationPropertyDependentDataAnnotations	Entity=Entities[Index];
...
//----------------------------------------------------------------------------------------------------------------------
		public string Print(int? Index)
		{
			...
			if (Index!=null)
			{
				SB.AppendLine($"ENTITY ATTRIBUTE ON NAVIGATION PROPERTY DEPENDENT DATA ANNOTATIONS [{Index}]:");
			}
			else
			{
				SB.AppendLine($"ENTITY ATTRIBUTE ON NAVIGATION PROPERTY DEPENDENT DATA ANNOTATIONS:");
			}
