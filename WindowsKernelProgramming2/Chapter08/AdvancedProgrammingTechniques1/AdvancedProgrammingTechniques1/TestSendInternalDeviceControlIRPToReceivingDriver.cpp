...
NTSTATUS TestSendInternalDeviceControlIRPToReceivingDriver(DEVICE_OBJECT* DeviceObject, IRP* Irp)
{
	...
	do
	{
		...
		// MAJOR FUNCTION je nastavena na VALUE [IRP_MJ_INTERNAL_DEVICE_CONTROL].
		PIRP													ReceivingDriverIRP=IoBuildDeviceIoControlRequest(IOCTL_TEST_RECEIVING_IRP,ReceivingDriverDeviceObject,nullptr,0,nullptr,0,TRUE,&MyEvent,&ReceivingDriverIoStatusBlock);
