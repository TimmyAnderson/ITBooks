...
typedef struct _DEVICE_EXTENSION
{
	...
	// Pocet BYTES, ktore sa maju preniest v tomto TRANSFER.
	ULONG														DMANumberOfBytesRemainingToTransfer;
	// Aktualny index SCATTER-GATHER ELEMENT.
	ULONG														DMAActualIndexOfSGLElement;
	// Pocet spracovavanych SCATTER-GATHER ELEMENTS pre aktualnu STAGE.
	ULONG														DMANumberOfProcessedSGLElementsForCurrentStage;
	// Velkost READ BUFFER.
	size_t														ReadBufferSize1;
