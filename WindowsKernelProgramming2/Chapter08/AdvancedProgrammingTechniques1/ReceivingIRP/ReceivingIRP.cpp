...
NTSTATUS DispatchRoutineDeviceControl(DEVICE_OBJECT* DeviceObject, IRP* Irp)
{
	...
	if (Code==IOCTL_TEST_RECEIVING_IRP)
	{
		Status=TestDeviceControlReceivingIRP(DeviceObject,Irp);
	}
	else
	{
...
//----------------------------------------------------------------------------------------------------------------------
NTSTATUS DispatchRoutineInternalDeviceControl(DEVICE_OBJECT* DeviceObject, IRP* Irp)
{
	const char*													FunctionName=__FUNCTION__;
	...
	if (Code==IOCTL_TEST_RECEIVING_IRP)
	{
		Status=TestInternalDeviceControlReceivingIRP(DeviceObject,Irp);
	}
	else
	{
		KdPrint(("!!!!! DRIVER [%wZ] FAILED to RECOGNIZE CODE [%lu] !!!\n",DeviceObject->DriverObject->DriverName,Code));
...
NTSTATUS DriverEntry(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath)
{
	...
	DriverObject->MajorFunction[IRP_MJ_INTERNAL_DEVICE_CONTROL]=DispatchRoutineInternalDeviceControl;
