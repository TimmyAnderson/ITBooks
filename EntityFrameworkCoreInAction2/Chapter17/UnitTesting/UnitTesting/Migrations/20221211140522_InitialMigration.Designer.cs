...
namespace UnitTesting.Migrations
{
    ...
    [Migration("20221211140522_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnitTesting.CEntityDependent", b =>
                {
            ...
            modelBuilder.Entity("UnitTesting.CEntityPrincipal", b =>
                {
                    b.Property<int>("EntityPrincipalID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("UnitTesting.CTestEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("UnitTesting.CEntityDependent", b =>
                {
                    b.HasOne("UnitTesting.CEntityPrincipal", "EntityPrincipal")
