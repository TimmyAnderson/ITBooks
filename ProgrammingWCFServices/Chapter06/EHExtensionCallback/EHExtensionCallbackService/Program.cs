...
//-------------------------------------------------------------------------------------------------------
namespace EHExtensionCallbackService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CEHExtensionCallbackService>	Service=new CServiceHostWrapper<CEHExtensionCallbackService>();
			...
			Service.AddServiceEndpoint<IEHExtensionCallbackContract>(TCPBinding,"net.tcp://localhost:9001/IEHExtensionCallbackContract");
