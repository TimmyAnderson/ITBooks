...
void ComplexHostWithAssemblyLoadingManager(void)
{
	...
	try
	{
		...
		if (FAILED(HR=CLRControl->SetAppDomainManagerType(L"BagAppDomainManager, Version=1.0.0.0, Culture=neutral, PublicKeyToken=AE009311F56808A0",L"BagAppDomainManager.CBagAppDomainManager")))
		{
			throw(CHelpers::PrepareLogMessage(L"SetAppDomainManagerType() FAILED.",HR));
		}
