...
//----------------------------------------------------------------------------------------------------------------------
	...
	public sealed class CEntityForeignKeyName2PrincipalConventions
	{
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
		...
		private IList<CEntityForeignKeyName2DependentConventions>	MEntitiesDependent;
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		public CEntityForeignKeyName2PrincipalConventions()
		{
...
//----------------------------------------------------------------------------------------------------------------------
		public CEntityForeignKeyName2PrincipalConventions(string EntityPrincipalValue)
		{
			MEntityPrincipalID=default;
...
//----------------------------------------------------------------------------------------------------------------------
		public CEntityForeignKeyName2PrincipalConventions(string EntityPrincipalValue, IList<CEntityForeignKeyName2DependentConventions> EntitiesDependent)
		{
			MEntityPrincipalID=default;
			MEntityPrincipalValue=EntityPrincipalValue;
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		public IList<CEntityForeignKeyName2DependentConventions>	EntitiesDependent
		{
			get
			{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		public static void PrintToConsole(CEntityForeignKeyName2PrincipalConventions[] Entities)
		{
			for(int Index=0;Index<Entities.Length;Index++)
			{
				CEntityForeignKeyName2PrincipalConventions		Entity=Entities[Index];
...
//----------------------------------------------------------------------------------------------------------------------
		public string Print(int? Index)
		{
			...
			if (Index!=null)
			{
				SB.AppendLine($"ENTITY FOREIGN KEY NAME 2 PRINCIPAL CONVENTIONS [{Index}]:");
			}
			else
			{
				SB.AppendLine($"ENTITY FOREIGN KEY NAME 2 PRINCIPAL CONVENTIONS:");
			}
			...
			if (MEntitiesDependent!=null)
			{
				...
				{
					CEntityForeignKeyName2DependentConventions	EntityDependent=MEntitiesDependent[EntityDependentIndex];
