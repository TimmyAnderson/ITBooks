...
namespace PerformanceTuning1.Migrations
{
    ...
    [Migration("20230113063512_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PerformanceTuning1.CEntityDependent", b =>
                {
            ...
            modelBuilder.Entity("PerformanceTuning1.CEntityPrecompiledQueries", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("EntitiesPrecompiledQueries", (string)null);
                });

            modelBuilder.Entity("PerformanceTuning1.CEntityPrincipal", b =>
                {
                    b.Property<int>("EntityPrincipalID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PerformanceTuning1.CTestEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PerformanceTuning1.CEntityDependent", b =>
                {
                    b.HasOne("PerformanceTuning1.CEntityPrincipal", "EntityPrincipal")
