...
{
      11,     0,    -1,    12,    -1,     1,    -1,    12,    13,    14,
      -1,    14,    -1,     4,    -1,     5,    -1,    14,     6,    16,
      -1,    -1,    14,    15,     7,    16,    -1,    16,    -1,     1,
      -1,     3,    -1,     8,    12,     9,    -1
};
...
static const char *const yytname[] =
{
  ...
  "'('", "')'", "$accept", "COMMAND", "EXP", "ADDOP", "TERM", "$@1",
  "FACTOR", 0
};
#endif
...
{
       0,    12,    13,     0,     0,     2,     5,    11,    12,     0,
       1,     6,     7,     0,     0,     0,    14,     4,     8,     0,
      10
};
...
{
      -1,     4,    -4,     0,    15,     8,    11,    -4,    -4,     1,
      -4,    -4,    -4,     0,     6,    12,    -4,    11,    -4,     6,
      -4
};
...
{
       1,     8,     2,     2,    -3,    11,    12,     3,     3,     2,
      16,    18,    11,    12,     3,    10,    20,    14,    -9,    19,
       9,     0,    17
};
...
{
       0,     1,     3,     8,    11,    12,    14,    16,     1,    12,
       0,     4,     5,    13,     6,    15,     9,    14,    16,     7,
      16
};
...
yyreduce:
  ...
  case 9:
    ...
    {printf("EMBEDDED ACTION - DIVISION !\n");;}
    break;

  case 10:

    {(yyval.Val)=(yyvsp[(1) - (4)].Val)/(yyvsp[(4) - (4)].Val);;}
    break;
