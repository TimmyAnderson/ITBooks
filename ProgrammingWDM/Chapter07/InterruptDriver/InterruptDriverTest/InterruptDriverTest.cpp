...
//-------------------------------------------------------------------------------------------------------
const wchar_t*													DRIVER_NAME=L"\\\\.\\InterruptDriver";
//-------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------
void Test1(void)
...
void Test3(void)
{
	...
	if (Handle!=INVALID_HANDLE_VALUE)
	{
		...
		if (DeviceIoControl(Handle,IOCTL_SYNCHRONIZATION_EXECUTION,NULL,0,NULL,0,&BytesReturned,NULL)!=FALSE)
		{
...
void Test4(void)
{
	...
	if (Handle!=INVALID_HANDLE_VALUE)
	{
		...
		if (DeviceIoControl(Handle,IOCTL_INTERRUPT_SPIN_LOCK,NULL,0,NULL,0,&BytesReturned,NULL)!=FALSE)
		{
			wprintf_s(L"IO CONTROL SUCCESSFULLY SENT !\n");
		}
		else
...
void Test5(void)
{
	...
	if (Handle!=INVALID_HANDLE_VALUE)
	{
		...
		if (DeviceIoControl(Handle,IOCTL_CUSTOM_DPC,NULL,0,NULL,0,&BytesReturned,NULL)!=FALSE)
		{
			wprintf_s(L"IO CONTROL SUCCESSFULLY SENT !\n");
		}
		else
