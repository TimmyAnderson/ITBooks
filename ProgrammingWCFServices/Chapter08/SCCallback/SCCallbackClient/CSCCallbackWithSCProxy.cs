...
{
//-------------------------------------------------------------------------------------------------------
	public class CSCCallbackWithSCProxy : DuplexClientBase<ISCCallbackWithSCContract>, ISCCallbackWithSCContract
	{
//-------------------------------------------------------------------------------------------------------
		public CSCCallbackWithSCProxy(ISCCallbackWithSCCallback Callback, Binding ProxyBinding, string EndpointAddress)
