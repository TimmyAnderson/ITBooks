...
//-------------------------------------------------------------------------------------------------------
namespace ConcurrencyCallbackService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CConcurrencyCallbackService>	Service=new CServiceHostWrapper<CConcurrencyCallbackService>();
			...
			Service.AddServiceEndpoint<IConcurrencyCallbackContract>(TCPBinding,"net.tcp://localhost:9001/IConcurrencyCallbackContract");
