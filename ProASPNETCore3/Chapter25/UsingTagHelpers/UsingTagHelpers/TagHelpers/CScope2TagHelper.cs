...
{
//----------------------------------------------------------------------------------------------------------------------
	// !!! TAG HELPER sa aplikuje IBA na HTML ELEMENTS [<div>] ak sa nachadzaju v PARENT HTML ELEMENT [<main>] a zaroven ma definovany HTML ATTRIBUTE 'First' a HTML ATTRIBUTE 'Second'.
	[HtmlTargetElement("div",ParentTag="main",Attributes="First,Second")]
	public sealed class CScope2TagHelper : TagHelper
	{
//----------------------------------------------------------------------------------------------------------------------
