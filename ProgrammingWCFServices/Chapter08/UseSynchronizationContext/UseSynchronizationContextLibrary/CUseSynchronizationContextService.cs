...
{
//-------------------------------------------------------------------------------------------------------
	[ServiceBehavior(InstanceContextMode=InstanceContextMode.PerCall, UseSynchronizationContext=true, ConcurrencyMode=ConcurrencyMode.Multiple)]
	public class CUseSynchronizationContextService : IUseSynchronizationContextContract, IDisposable
	{
//-------------------------------------------------------------------------------------------------------
		public CUseSynchronizationContextService()
		{
