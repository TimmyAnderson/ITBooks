...
//-------------------------------------------------------------------------------------------------------
		public CTerminal FindTerminalByTerminalValue(string TerminalValue)
		{
			...
			{
				throw(new CCompilerException(string.Format("Can't find TERMINAL for TERMINAL VALUE [{0}] !",TerminalValue)));
			}
		}
//-------------------------------------------------------------------------------------------------------
		public CTerminal FindTerminalByScanerTokenID(string ScanerTokenID)
		{
			...
			{
				throw(new CCompilerException(string.Format("Can't find TERMINAL for SCANER TOKEN ID [{0}] !",ScanerTokenID)));
			}
		}
//-------------------------------------------------------------------------------------------------------
		public CTerminal FindTerminalByScanerToken(CToken Token)
		{
			...
			{
				throw(new CCompilerException(string.Format("Can't find TERMINAL for SCANER TOKEN [{0}] !",Token)));
			}
		}
//-------------------------------------------------------------------------------------------------------
		public CTerminal FindTerminalByType(Type TerminalType)
		{
			...
			{
				throw(new CCompilerException(string.Format("Can't find TERMINAL TYPE [{0}] !",TerminalType)));
			}
		}
//-------------------------------------------------------------------------------------------------------
		public TTerminalType FindTerminalByType<TTerminalType>() where TTerminalType : CTerminal
		{
			...
			{
				throw(new CCompilerException(string.Format("Can't find TERMINAL TYPE [{0}] !",typeof(TTerminalType))));
			}
		}
//-------------------------------------------------------------------------------------------------------
	}
