...
{
//----------------------------------------------------------------------------------------------------------------------
	// !!! ATTRIBUTE [HtmlTargetElementAttribute] definuje na ktory HTML ELEMENT sa TAG HELPER aplikuje.
	// !!!!! TAG HELPER je volany pre KAZDY HTML ELEMENT [<div/>], dokonca aj taky, ktory nema nastavenu ziadnu PROPERTY.
	[HtmlTargetElement("div")]
	public sealed class CMyAsynchronousDivTagHelper : TagHelper
	{
//----------------------------------------------------------------------------------------------------------------------
