...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CPerSessionReleaseInstanceOnCompleteService>	Service=new CServiceHostWrapper<CPerSessionReleaseInstanceOnCompleteService>();
			...
			Service.AddServiceEndpoint<IPerSessionReleaseInstanceOnCompleteContract>(TCPBinding,"net.tcp://localhost:9001/IPerSessionReleaseInstanceOnCompleteContract");
