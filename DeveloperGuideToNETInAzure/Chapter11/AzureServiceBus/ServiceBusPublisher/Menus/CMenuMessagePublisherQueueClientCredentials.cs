...
{
//--------------------------------------------------------------------------------------------------------------------------------
	public sealed class CMenuMessagePublisherQueueClientCredentials : CMenu
	{
//--------------------------------------------------------------------------------------------------------------------------------
		public CMenuMessagePublisherQueueClientCredentials()
...
//--------------------------------------------------------------------------------------------------------------------------------
		...
		{
			ClientSecretCredential								Credential=new ClientSecretCredential(CConstants.TENANT_ID,CConstants.CLIENT_CREDENTIALS_CLIENT_ID_PUBLISHER,CConstants.CLIENT_CREDENTIALS_CLIENT_SECRET_PUBLISHER);
