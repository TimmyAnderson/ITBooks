...
//----------------------------------------------------------------------------------------------------------------------
	...
	[Authorize]
	public class ResourceAuthorization2Model : PageModel
	{
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		public ResourceAuthorization2Model(SignInManager<CCustomUser> SignInManager, IAuthorizationService AuthorizationService)
		{
...
//----------------------------------------------------------------------------------------------------------------------
        ...
        {
			CProtectedResource									ProtectedResource=new CProtectedResource("Timmy","This is DOCUMENT created by TIMMY !");
