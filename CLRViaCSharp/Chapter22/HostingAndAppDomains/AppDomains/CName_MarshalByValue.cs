...
//-------------------------------------------------------------------------------------------------------
	...
	[Serializable]
	public class CName_MarshalByValue
	{
//-------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------
		public CName_MarshalByValue(string FirstName, string LastName, int Age)
		{
...
//-------------------------------------------------------------------------------------------------------
		...
		{
			string												DomainName=AppDomain.CurrentDomain.FriendlyName;
			string												Text=string.Format("CName_MarshalByValue.PrintFullName() - Domain: [{0}] - Name: [{1}] !",DomainName,this.ToString());
