...
//------------------------------------------------------------------------------------------------------
class CCustomMarshalingByReferenceObject : public ICustomMarshalingByReferenceTest, public IMarshal
{
	private:
	...
	public:
		CCustomMarshalingByReferenceObject(void);
		virtual ~CCustomMarshalingByReferenceObject(void);
};
//------------------------------------------------------------------------------------------------------