...
//-------------------------------------------------------------------------------------------------------
namespace DefaultSingletonService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CDefaultSingletonService>	Service=new CServiceHostWrapper<CDefaultSingletonService>();
			...
			Service.AddServiceEndpoint<IDefaultSingletonContract>(TCPBinding,"net.tcp://localhost:9001/IDefaultSingletonContract");
