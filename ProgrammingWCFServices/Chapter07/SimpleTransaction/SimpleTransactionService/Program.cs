...
//-------------------------------------------------------------------------------------------------------
namespace SimpleTransactionService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CSimpleTransactionService>		Service=new CServiceHostWrapper<CSimpleTransactionService>();
			...
			Service.AddServiceEndpoint<ISimpleTransactionContract>(TCPBinding,"net.tcp://localhost:9001/ISimpleTransactionContract");
