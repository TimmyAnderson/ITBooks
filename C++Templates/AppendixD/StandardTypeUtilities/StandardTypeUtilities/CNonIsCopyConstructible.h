...
//----------------------------------------------------------------------------------------------------------------------
class CNonIsCopyConstructible final
{
//----------------------------------------------------------------------------------------------------------------------
	private:
		int														MField1;
	...
	public:
		CNonIsCopyConstructible(int Field1, double Field2);
		// !!! DEFAULT COPY CONSTRUCTOR je DELETED.
		CNonIsCopyConstructible(const CNonIsCopyConstructible&)=delete;
		~CNonIsCopyConstructible(void);
//----------------------------------------------------------------------------------------------------------------------
};
//----------------------------------------------------------------------------------------------------------------------