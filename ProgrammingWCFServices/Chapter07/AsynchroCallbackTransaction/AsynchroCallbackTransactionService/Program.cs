...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CAsynchroCallbackTransactionService>	Service=new CServiceHostWrapper<CAsynchroCallbackTransactionService>();
			...
			Service.AddServiceEndpoint<IAsynchroCallbackTransactionContract>(TCPBinding,"net.tcp://localhost:9001/IAsynchroCallbackTransactionContract");
