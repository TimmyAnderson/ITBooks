...
{
//-------------------------------------------------------------------------------------------------------
	public sealed class CInstruction_ADD : CInstruction
	{
//-------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------
		public CInstruction_ADD(COperand Operand1, COperand Operand2, string Comment)
			: base(Comment)
		{
			if ((Operand1 is COperand_Constant)==true)
			{
				throw(new CCompilerException("Operand1 MUST NOT be CONSTANT !"));
			}
			...
			{
				throw(new CCompilerException("Both OPERANDS CAN'T be MEMORY OPERANDS !"));
			}
...
//-------------------------------------------------------------------------------------------------------
		...
		{
			string												Instruction=string.Format("ADD {0},{1}",MOperand1.GetOperandText(),MOperand2.GetOperandText());
