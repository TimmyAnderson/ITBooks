...
#include <comdef.h>
//------------------------------------------------------------------------------------------------------
class CApartmentThreadingModelObjectFactory : public IClassFactory
{
	private:
	...
	public:
		CApartmentThreadingModelObjectFactory(void);
		virtual ~CApartmentThreadingModelObjectFactory(void);
};
//------------------------------------------------------------------------------------------------------