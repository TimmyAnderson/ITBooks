...
//-------------------------------------------------------------------------------------------------------
		...
		{
			// Tento kod zachyti kazdu vyniku a transformuje ju na zabuzdrenu excepion cez FaultException<ObjectDisposedException> a tym padom VZDY BUDE NA KLIENT PRENESENA KOREKTNA FaultException<Exception> EXCEPTION A NEDOJDE K UZATOVRENIU PROXY.
