...
//----------------------------------------------------------------------------------------------------------------------
class CIsNoThrowCopyAssignable final
{
//----------------------------------------------------------------------------------------------------------------------
	private:
		int														MField1;
	...
	public:
		CIsNoThrowCopyAssignable& operator=(const CIsNoThrowCopyAssignable& Other) noexcept;
	...
	public:
		CIsNoThrowCopyAssignable(int Field1, double Field2);
		~CIsNoThrowCopyAssignable(void);
//----------------------------------------------------------------------------------------------------------------------
};
//----------------------------------------------------------------------------------------------------------------------