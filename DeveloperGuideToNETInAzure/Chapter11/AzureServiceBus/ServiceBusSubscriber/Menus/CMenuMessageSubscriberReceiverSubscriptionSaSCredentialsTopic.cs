...
{
//--------------------------------------------------------------------------------------------------------------------------------
	public sealed class CMenuMessageSubscriberReceiverSubscriptionSaSCredentialsTopic : CMenu
	{
//--------------------------------------------------------------------------------------------------------------------------------
		public CMenuMessageSubscriberReceiverSubscriptionSaSCredentialsTopic()
...
//--------------------------------------------------------------------------------------------------------------------------------
		...
		{
			string												SaSToken=CreateSaSToken(CConstants.SERVICE_BUS_FULLY_QUALIFIED_TOPIC_URL,CConstants.SAS_AUTHORIZATION_RULE_SERVICE_BUS_TOPIC_NAME_SUBSCRIBER,CConstants.SAS_AUTHORIZATION_RULE_SERVICE_BUS_TOPIC_KEY_SUBSCRIBER);
