...
{
//------------------------------------------------------------------------------
	public class CGridSplitterCN : Window
	{
//------------------------------------------------------------------------------
		public CGridSplitterCN()
		{
			...
			// !!!!! Ak nastavim ResizeBehavior na 'CurrentAndNext', tak SIZED budu COLUMNS 1 a 2.
			GS.ResizeBehavior=GridResizeBehavior.CurrentAndNext;
