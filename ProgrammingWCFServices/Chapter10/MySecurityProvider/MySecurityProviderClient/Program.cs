...
//-------------------------------------------------------------------------------------------------------
		...
		{
			CMySecurityProviderProxy			Client=null;
			...
			try
			{
				Client=new CMySecurityProviderProxy(TCPBinding,"net.tcp://localhost:9001/IMySecurityProviderContract");
				...
				Client.ClientCredentials.ServiceCertificate.SetDefaultCertificate(StoreLocation.LocalMachine,StoreName.TrustedPeople,X509FindType.FindBySubjectName,"TestMYProvider");
