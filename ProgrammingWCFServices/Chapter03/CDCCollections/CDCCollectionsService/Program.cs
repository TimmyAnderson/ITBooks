...
//-------------------------------------------------------------------------------------------------------
namespace CDCCollectionsService
{
//-------------------------------------------------------------------------------------------------------
	class Program
	{
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CCDCCollectionsService>			Service=new CServiceHostWrapper<CCDCCollectionsService>();
			...
			Service.AddServiceEndpoint<ICDCCollectionsContract>(TCPBinding,"net.tcp://localhost:9001/ICDCCollectionsContract");
