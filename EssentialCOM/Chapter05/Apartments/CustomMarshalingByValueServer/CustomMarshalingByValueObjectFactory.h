...
#include <comdef.h>
//------------------------------------------------------------------------------------------------------
class CCustomMarshalingByValueObjectFactory : public IClassFactory
{
	private:
	...
	public:
		CCustomMarshalingByValueObjectFactory(void);
		virtual ~CCustomMarshalingByValueObjectFactory(void);
};
//------------------------------------------------------------------------------------------------------