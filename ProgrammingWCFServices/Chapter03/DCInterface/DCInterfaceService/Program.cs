...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CDCInterfaceService>		Service=new CServiceHostWrapper<CDCInterfaceService>();
			...
			Service.AddServiceEndpoint<IDCInterfaceContract>(TCPBinding,"net.tcp://localhost:9001/IDCInterfaceContract");
