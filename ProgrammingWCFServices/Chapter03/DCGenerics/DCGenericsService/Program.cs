...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CDCGenericsService<string>>	Service=new CServiceHostWrapper<CDCGenericsService<string>>();
			...
			Service.AddServiceEndpoint<IDCGenericsContract<string>>(TCPBinding,"net.tcp://localhost:9001/IDCGenericsContract");
