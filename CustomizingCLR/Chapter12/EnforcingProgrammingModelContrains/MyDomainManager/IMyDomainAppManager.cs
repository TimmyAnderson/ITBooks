...
//-------------------------------------------------------------------------------------------------------
		...
		void CreateNewDomainAndGenerateOrphanedLock(string DomainName);
		void CreateNewDomainAndGenerateSlowThreadAbort(string DomainName);
		void CreateNewDomainAndGenerateUnhandledException(string DomainName);
		void CreateNewDomainAndNewThread(string DomainName);
//-------------------------------------------------------------------------------------------------------
	}
//-------------------------------------------------------------------------------------------------------
}
