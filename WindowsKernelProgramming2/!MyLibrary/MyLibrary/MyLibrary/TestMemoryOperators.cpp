...
NTSTATUS TestMemoryOperators(DEVICE_OBJECT* DeviceObject, IRP* Irp)
{
...

	{
		...
		CTestClass1*											Object=new (POOL_FLAG_PAGED) CTestClass1(true,100,-1000000,1000000000);
...

	{
		...
		CTestClass2*											Object=new (POOL_FLAG_NON_PAGED) CTestClass2(true,200,-2000000,2000000000,-3000000000,4000000000);
