...
//----------------------------------------------------------------------------------------------------------------------
		static MyAccountController()
		{
			...
			UsersCollection.Add(new CUserProperties("timmy","aaa",new string[]{CRoles.ROLE_1,CRoles.ROLE_2}));
			UsersCollection.Add(new CUserProperties("jenny","bbb",new string[]{CRoles.ROLE_1,CRoles.ROLE_2,CRoles.ROLE_3}));
			UsersCollection.Add(new CUserProperties("josh","ccc",new string[]{CRoles.ROLE_2,CRoles.ROLE_3}));
			UsersCollection.Add(new CUserProperties("lucas","ddd",new string[]{CRoles.ROLE_1,CRoles.ROLE_3}));
