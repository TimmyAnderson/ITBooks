...
{
//----------------------------------------------------------------------------------------------------------------------
	public sealed class CMyHealthCheck4 : IHealthCheck
	{
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
		public Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext Context, CancellationToken CancellationToken)
		{
			...
			{
				HealthCheckResult								Result=HealthCheckResult.Healthy("CHECK 4 - STATUS [HEALTHY].");
			...
			{
				HealthCheckResult								Result=HealthCheckResult.Degraded("CHECK 4 - STATUS [DEGRADED].");
				Task<HealthCheckResult>							ResultTask=Task.FromResult<HealthCheckResult>(Result);
			...
			{
				HealthCheckResult								Result=HealthCheckResult.Unhealthy("CHECK 4 - STATUS [UNHEALTHY].");
				Task<HealthCheckResult>							ResultTask=Task.FromResult<HealthCheckResult>(Result);
			...
			{
				HealthCheckResult								Result=HealthCheckResult.Unhealthy("CHECK 4 - UNKNOWN STATUS.");
				Task<HealthCheckResult>							ResultTask=Task.FromResult<HealthCheckResult>(Result);
