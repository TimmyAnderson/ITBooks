...
//----------------------------------------------------------------------------------------------------------------------
class CNonIsNoThrowMoveAssignable final
{
//----------------------------------------------------------------------------------------------------------------------
	private:
		int														MField1;
	...
	public:
		CNonIsNoThrowMoveAssignable& operator=(CNonIsNoThrowMoveAssignable&& Other);
	...
	public:
		CNonIsNoThrowMoveAssignable(int Field1, double Field2);
		~CNonIsNoThrowMoveAssignable(void);
//----------------------------------------------------------------------------------------------------------------------
};
//----------------------------------------------------------------------------------------------------------------------