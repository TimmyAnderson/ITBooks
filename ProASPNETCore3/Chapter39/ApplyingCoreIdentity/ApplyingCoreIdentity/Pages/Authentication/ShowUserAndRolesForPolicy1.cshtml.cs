...
{
//----------------------------------------------------------------------------------------------------------------------
	// !!! RAZOR PAGE je pristupna iba USERS, ktory splnaju POLICY 'CustomPolicy1'.
	[Authorize(Policy="CustomPolicy1")]
    public class ShowUserAndRolesForPolicy1Model : PageModel
    {
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		public ShowUserAndRolesForPolicy1Model(UserManager<CCustomUser> UserManager, RoleManager<CCustomRole> RoleManager, SignInManager<CCustomUser> SignInManager)
		{
