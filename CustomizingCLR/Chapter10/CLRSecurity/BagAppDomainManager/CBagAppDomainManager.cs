...
//-------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------
		// !!! Vrati instanciu CUSTOM HOST SECURITY MANAGER.
		// !!!!! Ked CLASS CMyHostSecurityManager bola v INEJ ASSEMBLY ako BagAppDomainManager, tak mi HOST NESPUSTIL CLR, lebo nevedel najst nejaku (neviem aku) ASSEMBLY.
		public override HostSecurityManager						HostSecurityManager
		{
			get
			{
				return(new CMyHostSecurityManager());
			}
		}
//-------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------
