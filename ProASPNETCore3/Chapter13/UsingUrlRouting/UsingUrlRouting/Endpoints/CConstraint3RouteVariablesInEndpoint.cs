...
{
//----------------------------------------------------------------------------------------------------------------------
	public class CConstraint3RouteVariablesInEndpoint
	{
//----------------------------------------------------------------------------------------------------------------------
		public async Task ProcessEndpointRequest(HttpContext Context)
		{
			...
			CResult												Result=new CResult(Context.Request.GetDisplayUrl(),nameof(CConstraint3RouteVariablesInEndpoint),Data);
