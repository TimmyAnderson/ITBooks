...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CAuditingService>			Service=new CServiceHostWrapper<CAuditingService>();
			...
			// Nastavim auditing.
			ServiceSecurityAuditBehavior		SecurityAudit=Service.Host.Description.Behaviors.Find<ServiceSecurityAuditBehavior>( );

			if(SecurityAudit==null)
			{
				SecurityAudit=new ServiceSecurityAuditBehavior();

				// Dam do Aplication logu.
				...
				Service.Host.Description.Behaviors.Add(SecurityAudit);
			}
			else
			{
				// Dam do Aplication logu.
			...
			Service.AddServiceEndpoint<IAuditingContract>(TCPBinding,"net.tcp://localhost:9001/IAuditingContract");
