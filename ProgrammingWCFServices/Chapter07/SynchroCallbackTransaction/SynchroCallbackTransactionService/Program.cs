...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CSynchroCallbackTransactionService>		Service=new CServiceHostWrapper<CSynchroCallbackTransactionService>();
			...
			Service.AddServiceEndpoint<ISynchroCallbackTransactionContract>(TCPBinding,"net.tcp://localhost:9001/ISynchroCallbackTransactionContract");
