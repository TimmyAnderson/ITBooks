...
{
//-------------------------------------------------------------------------------------------------------
	public class CTransactionFlowBProxy : ClientBase<ITransactionFlowBContract>, ITransactionFlowBContract
	{
//-------------------------------------------------------------------------------------------------------
		public CTransactionFlowBProxy(Binding ProxyBinding, string EndpointAddress)
