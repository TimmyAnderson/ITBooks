...
{
//----------------------------------------------------------------------------------------------------------------------
	// !!! TAG HELPER sa aplikuje na HTML ELEMENT [<div>], ktory ma definovany HTML ATTRIBUTE 'Use' a takisto na HTML ELEMENT [<main>].
	[HtmlTargetElement("div",Attributes="Use")]
	[HtmlTargetElement("main")]
	public sealed class CScope4TagHelper : TagHelper
	{
//----------------------------------------------------------------------------------------------------------------------
