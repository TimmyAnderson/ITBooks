...
/*
   ...
   B. Hodnotu [SFunctionXXXCheck<wstring>::RESULT] bude C++ interpretovat nasledovne.
	  ...
	  !!! 6. C++ sa pokusi pouzit 2. VERZIU METHOD [SFalseValue CheckIfHasMethodXXX(...)]. Kedze ta nema ziaden EXPRESSION na vyhodnotenie, C++ vyhodnoti METHOD ako sposobilu pre substituciu do TEMPLATE STRUCTURE [SConditionResult].
	  !!!!! 7. C++ z DEKLRACIE METHOD [SFalseValue CheckIfHasMethodXXX(...)] urci jej TYPE. Kedze METHOD ma ako RETURN VALUE TYPE [SFalseValue], tento TYPE sa pouzije ako TYPE celej EXPRESSION.
...
//-----------------------------------------------------------------------------
	public:
		...
		// !!!!! METHOD NEMA BODY, pretoze sa pouziva iba v COMPILE-TIME na vyhodnotenie podmienky. Nevola sa v RUN-TIME a teda jej BODY NIE JE POTREBNE.
		static SFalseValue CheckIfHasMethodXXX(...);
//-----------------------------------------------------------------------------
};
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
