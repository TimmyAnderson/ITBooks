...
{
//--------------------------------------------------------------------------------------------------------------------------------
	public sealed class CMenuMessagePublisherQueueSaSCredentialsQueue : CMenu
	{
//--------------------------------------------------------------------------------------------------------------------------------
		public CMenuMessagePublisherQueueSaSCredentialsQueue()
...
//--------------------------------------------------------------------------------------------------------------------------------
		...
		{
			string												SaSToken=CreateSaSToken(CConstants.SERVICE_BUS_FULLY_QUALIFIED_QUEUE_URL,CConstants.SAS_AUTHORIZATION_RULE_SERVICE_BUS_QUEUE_NAME_PUBLISHER,CConstants.SAS_AUTHORIZATION_RULE_SERVICE_BUS_QUEUE_KEY_PUBLISHER);
