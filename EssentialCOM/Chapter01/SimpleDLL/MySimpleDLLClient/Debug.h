...
//------------------------------------------------------------------------------------------------------
std::wstring PrepareLogMessage(std::wstring LogMessage, HRESULT HR)
{
	HLOCAL														HLocal=NULL;
	DWORD														SystemLocale=MAKELANGID(LANG_NEUTRAL, SUBLANG_NEUTRAL);
	...
	std::wstring												ErrorMessage=LogMessage;
...
//------------------------------------------------------------------------------------------------------
void ThrowWString(HRESULT HR, std::wstring ErrorText)
{
	if (FAILED(HR))
	{
		std::wstring											Exception=PrepareLogMessage(ErrorText,HR);
