...
{
//------------------------------------------------------------------------
	// !!!!! Sluzi ako HOST a kedze je UIElement MA LAYOUT FAZU.
...
//------------------------------------------------------------------------
		public CUIElement()
		{
			...
			// Pridam CUSTOM VISUAL CVisual renderujuci 2 elipsy.
			MHostVisuals.Add(new CVisual());

			// Pridam CUSTOM DRAWING VISUAL CDrawingVisual renderujuci 3 elipsy.
