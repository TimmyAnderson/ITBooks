...
#include <crtdbg.h>
#include <process.h>
#include "..\MethodsNameClashServer\MethodsNameClashServer_h.h"
...
void TestCOM(void)
{
	...
	HRESULT														HR=CoCreateInstance(CLSID_MethodsNameClashObject,NULL,CLSCTX_INPROC_SERVER,__uuidof(IGetText1),(void**) &Interface1);
