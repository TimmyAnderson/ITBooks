...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CConcurrencySingleService>		Service=new CServiceHostWrapper<CConcurrencySingleService>();
			...
			Service.AddServiceEndpoint<IConcurrencySingleContract>(TCPBinding,"net.tcp://localhost:9001/IConcurrencySingleContract");
