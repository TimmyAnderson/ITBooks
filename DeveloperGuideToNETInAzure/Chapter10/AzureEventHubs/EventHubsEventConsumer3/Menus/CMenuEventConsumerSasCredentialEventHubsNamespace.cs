...
{
//--------------------------------------------------------------------------------------------------------------------------------
	public sealed class CMenuEventConsumerSasCredentialEventHubsNamespace : CMenu
	{
//--------------------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------------------------------------
		public CMenuEventConsumerSasCredentialEventHubsNamespace()
...
//--------------------------------------------------------------------------------------------------------------------------------
		...
		{
			string												SaSToken=CreateSaSToken(CConstants.EVENT_HUB_FULLY_QUALIFIED_NAMESPACE_URL,CConstants.SAS_AUTHORIZATION_RULE_EVENT_HUBS_NAMESPACE_NAME_CONSUMER,CConstants.SAS_AUTHORIZATION_RULE_EVENT_HUBS_NAMESPACE_KEY_CONSUMER);
