...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CImpersonationService>		Service=new CServiceHostWrapper<CImpersonationService>();
			...
			Service.AddServiceEndpoint<IImpersonationContract>(TCPBinding,"net.tcp://localhost:9001/IImpersonationContract");
