...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
void SystemThreadsThread1(PVOID StartContext)
{
...
//----------------------------------------------------------------------------------------------------------------------
void SystemThreadsThread2(PVOID StartContext)
{
	UNREFERENCED_PARAMETER(StartContext);
...
void TestSystemThreads(void)
{
	...
	Status=CHelpers::CreateThread("111",SystemThreadsThread1,nullptr,&ThreadObject1);
	...
	Status=CHelpers::CreateThread("222",SystemThreadsThread2,nullptr,&ThreadObject2);
