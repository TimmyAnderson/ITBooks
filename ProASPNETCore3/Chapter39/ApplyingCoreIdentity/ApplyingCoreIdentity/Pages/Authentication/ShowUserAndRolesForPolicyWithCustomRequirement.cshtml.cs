...
{
//----------------------------------------------------------------------------------------------------------------------
	// !!! RAZOR PAGE je pristupna iba USERS, ktory splnaju CUSTOM POLICY s CUSTOM REQUIREMENT.
	[Authorize(Policy="CustomPolicyWithCustomRequirement")]
    public class ShowUserAndRolesForPolicyWithCustomRequirementModel : PageModel
    {
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
		public ShowUserAndRolesForPolicyWithCustomRequirementModel(UserManager<CCustomUser> UserManager, RoleManager<CCustomRole> RoleManager, SignInManager<CCustomUser> SignInManager)
		{
