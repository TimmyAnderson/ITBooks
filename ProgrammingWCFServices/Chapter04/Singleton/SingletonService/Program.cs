...
//-------------------------------------------------------------------------------------------------------
		static void Main(string[] args)
		{
			...
			CServiceHostWrapper<CSingletonService>			Service=new CServiceHostWrapper<CSingletonService>();
			...
			Service.AddServiceEndpoint<ISingletonContract>(TCPBinding,"net.tcp://localhost:9001/ISingletonContract");
