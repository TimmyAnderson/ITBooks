...
namespace UsingGRPC {
  ...
  public static partial class RepeatedTypes
  {
    ...
    /// <summary>Base class for server-side implementations of RepeatedTypes</summary>
    [grpc::BindServiceMethod(typeof(RepeatedTypes), "BindService")]
    public abstract partial class RepeatedTypesBase
    {
      /// <summary>
      ///--------------------------------------------------------------------------------------------------------------------------------
      /// </summary>
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::UsingGRPC.RepeatedTypesResponse> ProcessRepeatedTypes(global::UsingGRPC.RepeatedTypesRequest request, grpc::ServerCallContext context)
      {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(RepeatedTypesBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          .AddMethod(__Method_ProcessRepeatedTypes, serviceImpl.ProcessRepeatedTypes).Build();
    }
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, RepeatedTypesBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_ProcessRepeatedTypes, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::UsingGRPC.RepeatedTypesRequest, global::UsingGRPC.RepeatedTypesResponse>(serviceImpl.ProcessRepeatedTypes));
    }
