...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void TestCharacterCategory(void)
{
	PrintLineSeparator();

	wcout << L"FUNCTION iswalnum('a') [" << ((iswalnum(L'a')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswalnum(' ') [" << ((iswalnum(L' ')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswalpha('a') [" << ((iswalpha(L'a')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswalpha('1') [" << ((iswalpha(L'1')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswlower('a') [" << ((iswlower(L'a')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswlower('A') [" << ((iswlower(L'A')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswupper('A') [" << ((iswupper(L'A')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswupper('a') [" << ((iswupper(L'a')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswdigit('1') [" << ((iswdigit(L'1')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswdigit('a') [" << ((iswdigit(L'a')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswxdigit('f') [" << ((iswxdigit(L'f')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswxdigit('g') [" << ((iswxdigit(L'g')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswcntrl('TAB') [" << ((iswcntrl(L'\t')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswcntrl(' ') [" << ((iswcntrl(L' ')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswgraph('X') [" << ((iswgraph(L'X')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswgraph('UNICODE 2602') [" << ((iswgraph(L'\u2602')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswspace(' ') [" << ((iswspace(L' ')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswspace('X') [" << ((iswspace(L'X')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswblank('TAB') [" << ((iswblank(L'\t')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswblank('X') [" << ((iswblank(L'X')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswprint('X') [" << ((iswprint(L'X')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswprint('UNICODE 0082') [" << ((iswprint(L'\u0082')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	wcout << L"FUNCTION iswprint('\"') [" << ((iswprint(L'"')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;
	wcout << L"FUNCTION iswpunct('X') [" << ((iswpunct(L'X')!=0) ? L"TRUE" : L"FALSE") << L"] !" << endl;

	PrintLineSeparator();

	wcout << L"FUNCTION towlower('T') [" << wchar_t(towlower('T')) << L"] !" << endl;
	wcout << L"FUNCTION towupper('t') [" << wchar_t(towupper('t')) << L"] !" << endl;
