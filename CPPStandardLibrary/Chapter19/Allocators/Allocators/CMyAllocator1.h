...
//-----------------------------------------------------------------------------
	...
	public:
		...
		{
			std::wcout << L"ALLOCATOR 1 - METHOD ALLOCATE CALLED !" << std::endl;
		...
		{
			std::wcout << L"ALLOCATOR 1 - METHOD DEALLOCATE CALLED !" << std::endl;
		...
		{
			std::wcout << L"ALLOCATOR 1 - METHOD CONSTRUCT CALLED !" << std::endl;
		...
		{
			std::wcout << L"ALLOCATOR 1 - METHOD DESTROY CALLED !" << std::endl;
