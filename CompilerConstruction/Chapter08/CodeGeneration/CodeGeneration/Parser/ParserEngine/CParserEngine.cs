...
//-------------------------------------------------------------------------------------------------------
		...
		public bool Parse(EParserType ParserType, CTokenCollection TokenCollection, out CParsingStackItem RootParsingStackItem, CCompilerErrorCollection Errors, bool DoErrorRecovery)
		{
			...
			while(true)
			{
				...
				{
					CParsingError									ParsingError1=new CParsingError("Can't find CELL in PARSING TABLE !",CurrentSourceCodeTerminal,CurrentItem,MSourceTerminalsQueue.GetTokenOnTop().SourceCodeIndex);
